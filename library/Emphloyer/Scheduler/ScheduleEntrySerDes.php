...
class ScheduleEntrySerDes {
  ...
  public function deserialize(array $attributes) {
    ...
    $entry = new \Emphloyer\Scheduler\ScheduleEntry($job, $attributes["id"], $attributes["minute"], $attributes["hour"], $attributes["dayOfMonth"], $attributes["month"], $attributes["dayOfWeek"]);
    return $entry;
  }
}
